...
import com.resoluteai.demoapp.ui.theme.DemoAppTheme
        ...
        setContent {
            DemoAppTheme {
                Surface(
                    ...
                    Watch(currentHour, currentMinutes, currentSeconds)
                }
            }
        }
    }
...
@Composable
fun Watch(currentHour: Int, currentMinutes: Int, currentSeconds: Int) {
        ...
        Canvas(modifier = Modifier) {
            ...
            for (i in 0..360 step 6) {
                if (i % 30 == 0) {
                    ...
                    Log.d("MainActivity", "lineHeight if: $lineHeight")
                } else {
                    lineHeight = 40f
                    strokeWidth = Stroke.HairlineWidth
                    Log.d("MainActivity", "lineHeight else: $lineHeight")
                }
